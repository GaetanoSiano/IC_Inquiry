...
Public Class IC_Hist
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack And Not IsCallback Then
            Session("IC_Hist_InitialLayout") = ASPxGridView1.SaveClientLayout()
    ...
    Private Sub ASPxGridView1_CustomCallback(sender As Object, e As ASPxGridViewCustomCallbackEventArgs) Handles ASPxGridView1.CustomCallback
        ...
        LayoutHelper.LoadLayout(Session("UserId"), LayoutId, Session("IC_Hist_InitialLayout"), ASPxGridView1, pageName)
    End Sub
End Class