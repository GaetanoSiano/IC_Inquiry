...
Public Class OE_Orders
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack And Not IsCallback Then
            Helper.LoadColumnCaptions(ASPxGridView1, "OEORDH.xml")
            Session("OE_Orders_InitialLayout") = ASPxGridView1.SaveClientLayout()
        End If
    End Sub
    ...
    Private Sub ASPxGridView1_CustomCallback(sender As Object, e As ASPxGridViewCustomCallbackEventArgs) Handles ASPxGridView1.CustomCallback
        ...
        LayoutHelper.LoadLayout(Session("UserId"), LayoutId, Session("OE_Orders_InitialLayout"), ASPxGridView1, pageName)
    End Sub
